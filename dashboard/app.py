...
# --- Upload File CSV ---
filename = st.file_uploader("Upload file CSV", type=["csv"])
if filename:
    # Baca file CSV dengan separator ";" dan encoding "utf-8"
    ...
    # Imputasi missing values: untuk kategori gunakan mode, untuk numerik gunakan mean
    ...
    # Pastikan kolom tanggal diubah ke format datetime (jika ada)
    if "date_start" in df.columns:
        df["date_start"] = pd.to_datetime(df["date_start"], errors="coerce")
        df["year_month"] = df["date_start"].dt.to_period("M").astype(str)
    
    # --- Definisi Kategori & Perhitungan Skor ---
    # Definisi kategori untuk rumah, sanitasi, dan perilaku
    kategori_rumah = [
        'langit_langit',
        'lantai',
        'dinding',
    ...
    # Pisahkan data sesuai kategori (drop baris dengan missing nilai)
    ...
    # Tambahkan label berdasarkan threshold 70
    threshold = 70
    ...
    # 1. Kebiasaan CTPS vs Jumlah Pasien
    ...
    # 2. Memiliki Hewan Ternak vs Jumlah Pasien
    ...
    # 3. Bar Chart: Persentase Rumah, Sanitasi, dan Perilaku Tidak Layak
    ...
    # 4. Bar Chart: Perbandingan Rumah Layak vs Tidak Layak (Jumlah)
    ...
    # 5. Bar Chart: Persentase Rumah Layak vs Tidak Layak
    ...
    # 6. Pie Chart: Rumah Layak vs Tidak Layak
    ...
    # 7. Pie Chart: Sanitasi Layak vs Tidak Layak
    ...
    # 8. Pie Chart: Perilaku Baik vs Tidak Baik
    ...
    # 9. Kategori Rumah Tidak Layak (Detail)
    st.subheader("Kategori Rumah Tidak Layak (Detail)")
    df = df.fillna('')  # pastikan tidak ada NaN
    total_rumah = len(df)
    ...
    # 10. Kategori Sanitasi Tidak Layak (Detail)
    ...
    # 11. Kategori Perilaku Tidak Sehat (Detail)
    ...
    st.success("Semua visualisasi telah dibuat!")
